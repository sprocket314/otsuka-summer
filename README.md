...
- **One map** (`#/map`) — embeds our own **Google My Map** (things to do in red, Rodrigo's food in green). Its id is `MYMAP_MID` in the script; the same pins are also downloadable as `otsuka-map.kml`.
